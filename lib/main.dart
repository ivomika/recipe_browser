  ...
  Widget build(BuildContext context) {
    return MultiRepositoryProvider(
      providers: [
        ...
        RepositoryProvider<ICountTypeRepository>(
            create: (context) => DriftCountTypeRepository(
              context.read<DriftAppDatabase>()
            )
        ),
        RepositoryProvider<ICollectionRepository>(
            create: (context) => DriftCollectionRepository(
              context.read<DriftAppDatabase>()
            )
        ),
      ],
